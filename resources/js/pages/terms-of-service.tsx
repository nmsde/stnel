                ...
                <section className="relative pt-16 pb-12">
                    <div className="mx-auto max-w-4xl px-6 lg:px-8">
                        <div className="mb-12 text-center">
                            <h1 className="text-4xl font-bold tracking-tight text-[#343434] sm:text-5xl">Terms of Service</h1>
                        ...
                        <div className="mb-16 grid grid-cols-1 gap-6 md:grid-cols-3">
                            <div className="rounded-2xl bg-gray-50 p-6 text-center">
                                <FileText className="mx-auto mb-3 h-8 w-8 text-[#FFCD45]" />
                                <h3 className="mb-2 font-semibold text-[#343434]">Clear Terms</h3>
                                <p className="text-sm text-gray-600">Straightforward terms without legal jargon</p>
                            </div>
                            <div className="rounded-2xl bg-gray-50 p-6 text-center">
                                <Scale className="mx-auto mb-3 h-8 w-8 text-[#FFCD45]" />
                                <h3 className="mb-2 font-semibold text-[#343434]">Fair Usage</h3>
                                <p className="text-sm text-gray-600">Reasonable limits designed for real use cases</p>
                            </div>
                            <div className="rounded-2xl bg-gray-50 p-6 text-center">
                                <AlertTriangle className="mx-auto mb-3 h-8 w-8 text-[#FFCD45]" />
                                <h3 className="mb-2 font-semibold text-[#343434]">Your Rights</h3>
                ...
                <section className="pt-16 pb-32">
                    <div className="mx-auto max-w-4xl px-6 lg:px-8">
                        <div className="prose prose-xl prose-gray prose-headings:text-[#343434] prose-headings:font-bold prose-h2:text-3xl prose-h2:mt-16 prose-h2:mb-8 prose-h3:text-xl prose-h3:mt-12 prose-h3:mb-6 prose-p:mb-8 prose-p:leading-loose prose-p:text-gray-700 prose-ul:mb-8 prose-ul:space-y-3 prose-li:leading-relaxed prose-a:text-[#FFCD45] prose-a:no-underline prose-a:font-medium hover:prose-a:text-[#FFD700] prose-strong:text-[#343434] prose-strong:font-semibold max-w-none">
                            ...
                            <p>
                                By accessing or using Stnel, you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part
                            ...
                            <p>
                                Stnel is a web-based platform that simplifies the management of Cloudflare Access policies. Our service allows you to:
                            </p>
                            <ul>
                            ...
                            <p>
                                <strong>Important:</strong> Stnel is a third-party service that integrates with Cloudflare. We are not affiliated with
                            ...
                            <p>To provide our service, you grant us permission to use your Cloudflare API tokens to:</p>
                            <ul>
                            ...
                            <p>
                                We will only use your API tokens as necessary to provide the service. You may revoke access at any time by deleting
                                your API token from Stnel or revoking it in Cloudflare.
                            </p>
                            ...
                            <p>
                                We strive to maintain high availability but cannot guarantee uninterrupted service. Stnel may be temporarily
                                unavailable due to maintenance, updates, or unforeseen issues.
                            </p>

                            <p>We will provide reasonable notice for planned maintenance when possible.</p>

                            <h2>7. Data and Privacy</h2>

                            <p>
                                Your privacy is important to us. Our collection and use of your information is governed by our
                                <Link href="/privacy-policy" className="text-[#FFCD45] hover:text-[#FFD700]">
                                    Privacy Policy
                                </Link>
                            ...
                            <p>Stnel currently operates on a free tier. If we introduce paid plans in the future:</p>
                            <ul>
                            ...
                            <h3>Our Rights</h3>
                            <p>
                                Stnel and its original content, features, and functionality are owned by us and are protected by international
                                copyright, trademark, patent, trade secret, and other intellectual property laws.
                            </p>

                            <h3>Your Rights</h3>
                            <p>
                                You retain all rights to your data and content. By using Stnel, you grant us a limited license to use your data solely
                            ...
                            <h3>By You</h3>
                            <p>
                                You may terminate your account at any time by deleting it from your account settings. Upon termination, we will delete
                                your data within 30 days.
                            </p>

                            <h3>By Us</h3>
                            <p>We may terminate your account immediately if you:</p>
                            <ul>
                            ...
                            <p>Your continued use of Stnel after changes are posted constitutes acceptance of the new Terms.</p>

                            <h2>14. Dispute Resolution</h2>

                            <p>
                                If you have a dispute with us, please contact us first at <a href="mailto:legal@stnel.com">legal@stnel.com</a>. We
                                will attempt to resolve disputes through good faith negotiation.
                            </p>

                            <h2>15. Governing Law</h2>

                            <p>
                                These Terms are governed by the laws of the jurisdiction in which Stnel operates, without regard to conflict of law
                                principles.
                            </p>
                            ...
                            <p>
                                These Terms, together with our Privacy Policy, constitute the entire agreement between you and Stnel regarding the use
                                of our service.
                            </p>
                            ...
                            <ul>
                                <li>
                                    Email: <a href="mailto:legal@stnel.com">legal@stnel.com</a>
                                </li>
                                <li>
                            ...
                            <div className="mt-16 rounded-2xl border border-[#FFCD45]/20 bg-[#FFCD45]/10 p-6">
                                <h3 className="mb-3 text-lg font-semibold text-[#343434]">Questions About These Terms?</h3>
                                <p className="mb-4 text-gray-700">
                                    We believe in transparency. If anything in these Terms is unclear or you have questions, we're happy to explain in
                                    plain language.
                                </p>
                                <a
                                    href="mailto:legal@stnel.com"
                                    className="inline-flex items-center font-medium text-[#343434] transition-colors hover:text-[#FFCD45]"
                                >
                                    Contact Legal Team
